    ...
    <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-2/3 w-full mx-auto overflow-auto">
            <div class="flex items-center justify-between mb-2">
                ...
                <a target="blank" href="{{ route('admin.product.create') }}" class="flex ml-auto text-white bg-indigo-500 border-0 py-1.5 px-3 text-sm focus:outline-none hover:bg-indigo-600 rounded">Adicionar</a>
            </div>
                ...
                @foreach ( $products as $p)
                    <tr @if ($loop->even) class="bg-gray-100" @endif>
                        ...
                        <td class="px-4 py-3 text-sm text-right space-x-3 text-gray-900">
                            <a href="{{ route('admin.product.edit', $p->id) }}" target="blank" class="mt-3 text-indigo-500 inline-flex items-center">Editar</a>
